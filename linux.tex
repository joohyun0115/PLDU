...
%$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
When a process spawns, the parent's \code{anonymous vma chain(avc)} are copyed
...
To translate physical addresses to virtual addresse, the \code{struct page} for
...
\code{struct address\_spcae}. If not, the queue header is located in the
per-core memory.
