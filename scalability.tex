...
systems scalability bottlenecks becasue the operating systems suffer from cache
...
file) in the Linux 4.5.0 kernel in order to reduce fork scalability bottlenecks,
and our scheme reveals that performance improvement by ranging from 1.6x
through 2.4x on a 120 core system.
\end{abstract}

\begin{IEEEkeywords}
scalability; Linux; udpate-heavy; log-based;
