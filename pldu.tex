...
%Paragraph 1:oplog와 ldu의 문제점 설명 



\subsection{Approach}

%Paragraph 1: LDU의 head pointer를 per-core 기반으로 수정한 버전 



%Paragraph 2: Insert-Remove Operation에 대한 처리 설명
...
%Paragraph 1:LDU Concurrent Updates 소스 코드 설명 
...
%Paragraph 2:LDU Deferred Updates 코드 설명 
