...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[height=1.2in]{graph/aim7.eps}
        \caption{Lorem ipsum, lorem ipsum}
    \end{subfigure}%
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[height=1.2in]{graph/exim.eps}
        \caption{Lorem ipsum, lorem ipsum}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[height=1.2in]{graph/lmbench.eps}
        \caption{Lorem ipsum, lorem ipsum}
    \end{subfigure}
    \caption{Caption place holder3}
