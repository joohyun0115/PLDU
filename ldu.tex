...
%Paragraph 1: CoW 기법 : read before physical update 




%Paragraph 2: MPSC lock-less list를 활용하는 Log 기반 방법




%Paragraph 3: Abosrbing - 로그를 집어 넣을 때 지우는 방법



%Paragraph 4: timestamp를 사용하지 않아도 되는 이유 설명
