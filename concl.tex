...
\else
We eliminate the synchronized timestamp counters by using the \deferu, and we
applied the LDU to Linux reverse mapping in order to achieve the scalability
during process spawning.
Evaluation results reveal that \deferu shows better performance up to 2.2 times
